...
namespace SAMS.BLL.Admissions
{
    public class AdmissionsBLL
    {
        ...
        public static AdmissionMDL GetAdmission(string session, int DocEntry)
        {
            try
            {
                ...
                return JsonConvert.DeserializeObject<AdmissionMDL>(getData);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
